...
const galleryImages = [
  { src: eventShaadi, title: "Grand Shaadi" },
  { src: eventEngagement, title: "Engagement Ceremony" },
  { src: eventHaldi, title: "Traditional Haldi" },
  { src: eventMehendi, title: "Elegant Mehendi" },
  { src: eventReception, title: "Royal Reception" },
  { src: eventSangeet, title: "Vibrant Sangeet" },
];

const GallerySection = () => {
  return (
    <section className="relative py-24 md:py-32 overflow-hidden bg-space-dark text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <iframe 
            ...
            src="https://www.youtube.com/embed/dQw4w9WgXcQ" // Placeholder URL, user can change
            title="Palace Tour"
